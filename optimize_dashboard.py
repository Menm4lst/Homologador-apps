...
def backup_and_replace():
    ...
    original_file = "homologador/ui/metrics_panel.py"
    backup_file = f"homologador/ui/metrics_panel_backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}.py"
    
    print("🔄 Actualizando metrics_panel.py con versión optimizada...")
    ...
    # Crear la versión completamente optimizada
    optimized_content = '''"""
...
'''
    ...
    print("   - Campos de base de datos correctos")
    print("   - Cálculos de métricas precisos")
    print("   - Mejor manejo de errores")
    print("   - UI mejorada con temas")
    print("   - Cache interno para rendimiento")
